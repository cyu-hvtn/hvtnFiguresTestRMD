...
<!-- Example 1: Standard boxplot figure, separate panels by antigen. --> 
...
case <- pt_plot(dat=lum, 
              ...
              colby = "trt01p",
              rx.ctrl = "P",
              y.title = "%s net MFI (MFI-blank)", #NOTE: %s is missing in output 
...
<!-- Example 2: Standard lineplot figure. Lines connecting ppt dots. --> 
...
tlf[[paste0("case", fig_num)]] <- list(caption=paste0(protname_short,": %s Response to %s"),
...
<!-- Example 3: Boxplot figure. Not defining y-axis cutoff and breaks -->
...
<!-- Example 4: Magnitude boxplot only, no responder counts. -->
...
<!-- Example 5: Magnitude boxplot only, with responder counts and lines connecting ppt dots. -->
...
<!-- Example 6: Response rate barplot only. -->
...
case <- pt_plot(dat=lum, 
              ...
              rx.ctrl = "P",
              y.title = "%s net MFI (MFI-blank)",
              page.footnote = "Showing response rate barplots only (mag.plot=F). \nTotal and responder counts are shown on top of the plots. Plot titles are shown.",
              test.pages = 1)
...
<!-- Example 7: Standard boxplot figure, x-axis labels are treatment arms and grouped by antigen. -->
...
<!-- Example 8: Standard boxplot figure, x-axis labels are treatment arms (treatment labels not shown) and grouped by antigen. -->
...
<!-- Example 9: Standard lineplot figure, x-axis labels are visit numbers and grouped by treatment arm. -->
...
case <- pt_plot(dat=lum, 
              ...
              rx.ctrl = "P",
              y.title = "%s net MFI (MFI-blank)",
              page.footnote = "x-axis labels are visitno and grouped by treatment arm in lineplots",
              y.lims = c(100,22000),
              cutoff.lower=100,
              cutoff.upper=22000,
              y.brk.major=c(100,1000,2000,3000,5000,10000,22000),
...
<!-- Example 10: Standard lineplot figure, x-axis labels are visit numbers and grouped by treatment arm (horizontal line above treatment arm). -->
...
case <- pt_plot(dat=lum, 
              ...
              page.footnote = "x-axis labels are visitno and grouped by treatment arm in lineplots. y title, x labels, and group labels are showing correctly (%%s Response to %s, Visit %%s, Group: %%s).\nBUG (not urgent): 1) page.title can't be \"\" to correctly show x/y titles with %%s. 2) plot.title will be %s when no %%s is included.", #NOTE: bug and %s is not shown 
              y.lims = c(100,22000),
              cutoff.lower=100,
              cutoff.upper=22000,
              y.brk.major=c(100,1000,2000,3000,5000,10000,22000),
...
<!-- Example 11: Boxplots based on all participants. Response rate barplots with 95% CI. -->
...
<!-- Example 12: No individual magnitude dots in magnitude boxplots (based on positive responders). -->
...
<!-- Example 13: Only showing individual magnitude dots. -->
