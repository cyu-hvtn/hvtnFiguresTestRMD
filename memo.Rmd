...
3. The figure number should be continuous. Missing figure numbers indicate hidden bugs/errors.

4. No missing parts in the figures. (e.g. the boxes are complete. Missing borders indicate narrow space between boxes and could be adjusted by box.width). Page titles are shown and complete (Figure number and caption.)

5. The response summarize numbers match the plots. 

6. The legends are showing colors/shapes in the figure only and match with the figure.
